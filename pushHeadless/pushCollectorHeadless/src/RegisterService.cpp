...
{
    QUrl url(m_configuration->pushInitiatorUrl() + "/subscribe");
    url.addQueryItem("appid",m_configuration->providerApplicationId());
    ...
    if (m_configuration->usingPublicPushProxyGateway()) {
